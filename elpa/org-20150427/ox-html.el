...
(defcustom org-html-validation-link
  "Sina Weibo:<a href=\"http://weibo.com/yougelu\">http://weibo.com/yougelu</a>"
  "Link to HTML validation service."
  :group 'org-export-html
  :type 'string)

(defcustom org-html-creator-string
  (format "Website:<a href=\"http://www.luxiaoyou.com/\">luxiaoyou.com</a> (<a href=\"http://www.luxiaoyou.com/webpages/about.html\">About</a>)"
	  emacs-version
    ...
    (when toc-entries
      (concat (format "<%s id=\"table-of-contents\">\n" outer-tag)
	      (format "<h%d>%s</h%d>\n"
		      ...
		      (org-html--translate "Contents" info)
		      org-html-toplevel-hlevel)
